...
define ( function (){
	...
	function drawORGateInternal(ctx, x , y , r,color,isNand){
   ...
   ctx.arc(x , y, r, 0.5 *Math.PI, 1.5*Math.PI);
    ...
    drawLine(ctx,x,y-r,x,y+r);
	
    drawLine(ctx,x,y-r/2,x+r,y-r/2);
	drawLine(ctx,x,y+r/2,x+r,y+r/2);
	...
	return	{
		drawANDGate : function (ctx, x , y , r,color){
			drawANDGateInternal(ctx, x , y , r,color,false);
		},
		drawNANDGate : function (ctx, x , y , r,color){
			drawANDGateInternal(ctx, x , y , r,color,true);
		},
		drawORGate : function drawORGate(ctx, x , y , r,color){
			drawORGateInternal(ctx, x , y , r,color,false);
		},
		drawNORGate : function drawNORGate(ctx, x , y , r,color){
			drawORGateInternal(ctx, x , y , r,color,true);
		}
	};
	}
);
